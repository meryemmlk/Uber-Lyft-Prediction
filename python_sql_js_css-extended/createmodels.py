...
regr_uber = RandomForestRegressor(max_depth=15, random_state=0, n_estimators=500)
...
regr_lyft = RandomForestRegressor(max_depth=15, random_state=0, n_estimators=500)
